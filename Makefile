build: dist/antibiotics-0.3-py3-none-any.whl dist/antibiotics-0.3.tar.gz
...
dist/antibiotics-0.3-py3-none-any.whl dist/antibiotics-0.3.tar.gz &: antibiotics/__init__.py setup.py
